...
class Preprocessing:
    ...
    def OutliersRemoval(self, UAV_TYPE_IDX, X, y, flight_refs, ANOMALOUS_THRESHOLD = 11000):
        """Remove Outliers from the data in accordance with a user-defined threshold"""
    ...
    def DataSplitter(self, X, y, y_lookaheads, flight_refs,
        ...
        """Creates training, validation, and testing datasets for
        the high-level intent regression models"""
